...
const TABS = [
  { id: 'map', label: 'Map' },
  { id: 'see-her', label: 'If you see her' },
  { id: 'info', label: 'Her info' },
...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      <main>
        <nav className="tabs" role="tablist" aria-label="Gemma sections">
          {TABS.map((t) => (
            <button
              key={t.id}
              type="button"
        ...
        <AnimatePresence mode="wait">
          ...
          >
              ...
              <section className="map-section">
                ...
                {sightings.length === 0 && (
                  <p className="empty-note">
                    ...
                    &mdash; new sightings will appear here as they come in.
                  </p>
                )}
              </section>
            )}
            ...
            {tab === 'see-her' && (
              <section className="see-her">
                <h2>If you see her</h2>
                <p className="section-lede">
                  Gemma is very timid and will run if she&rsquo;s approached or called. The
                  best way to help is to stay calm, keep your distance, and tell us exactly
                  where and when you saw her.
                </p>
            ...
            {tab === 'info' && (
              <section className="info-section">
                <h2>Her info</h2>
                <p className="section-lede">
                  A quick description to help you recognize Gemma if you spot her.
                </p>
            ...
            {tab === 'spread' && (
              <section className="spread">
                ...
                <p className="section-lede">
                  Every share helps Gemma get home faster. Post this page on Facebook,
                  Nextdoor, and neighborhood group chats &mdash; or print a flyer to put up
                  nearby.
                </p>
                <ShareBar />
                ...
                <div className="spread-flyer">
                  ...
                  <div className="spread-flyer-text">
                    <h3>Print a flyer</h3>
                    <p>
                      Post it at vets, parks, and around the neighborhood. It includes
                      Gemma&rsquo;s photo, description, your contact number, and the QR code
                      above.
                    </p>
                    <button
                      type="button"
